...
HD_PWD='D:/Major_Project/zynet_Project_incorporated_OLED/MLP_oled/MLP_oled.runs/design_1_mlp_oled_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_mlp_oled_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_mlp_oled_0_1.tcl
