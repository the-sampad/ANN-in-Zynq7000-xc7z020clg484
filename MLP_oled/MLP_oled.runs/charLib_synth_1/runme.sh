...
HD_PWD='D:/Major_Project/zynet_Project_incorporated_OLED/MLP_oled/MLP_oled.runs/charLib_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log charLib.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source charLib.tcl
