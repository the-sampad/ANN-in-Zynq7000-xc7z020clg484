...
#
# Generated by export_simulation on Fri Apr 26 10:48:39 +0530 2024
#
################################################################################
...
'-reset_run' switch to the './init_sequence_rom.sh' script.

./init_sequence_rom.sh -reset_run
...
./init_sequence_rom.sh -noclean_files

For more information on the script, please type './init_sequence_rom.sh -help'.
